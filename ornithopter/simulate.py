...
def main():
    ...
    print(f"thrust_score:     {metrics['thrust_score']:.6f}")
    print(f"strouhal_score:   {metrics['strouhal_score']:.6f}")
    print(f"lift_score:       {metrics['lift_score']:.6f}")
    print(f"corrected_thrust: {metrics['corrected_thrust_N']:.6f}")
    print(f"corrected_lift:   {metrics['corrected_lift_N']:.6f}")
